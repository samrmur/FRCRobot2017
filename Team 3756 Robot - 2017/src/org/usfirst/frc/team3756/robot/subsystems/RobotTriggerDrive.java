...
public class RobotTriggerDrive extends RobotDrive {
	 ...
	 * @param leftMotor is a SpeedController Object which controls the speed of the left side of the robot
	 * @param rightMotor is a SpeedController Object which controls the speed of the left side of the robot
	 */
	 ...
	 * @param rearLeftMotor is an integer that represents the channel number of the front right motor
	 * @param frontRightMotor is an integer that represents the channel number of the back left motor
	 ...
	 * @param rearLeftMotor is the front right SpeedController object
	 * @param frontRightMotor is the back left SpeedController object
	 ...
	 * @param moveStick is the joystick being used to control the robot forwards & backwards
	 ...
	 * @param rotateAxis is the axis being used to 
	 */
	public void arcadeDrive(GenericHID moveStick, final int forwardsTrigger, final int backwardsTrigger, GenericHID rotateStick, final int rotateAxis) {
